      ...
      <div class="row">
        <div class="col">
          <iframe
            ...
            frameborder="0"
            loading="lazy"
            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDe47VbQ7TAf1Uh3sERy0QcExCljUSMhzI&amp;q=Kemala+Kapetanovi%C4%87a+17%2C+Sarajevo+71000&amp;zoom=15"
            width="100%"
            height="100%"
          ></iframe>
        </div>
        <div class="col-md-6 col-xl-4">
          <div>
            ...
            <p class="text-muted subtitle">
              Ukoliko imate bilo kakvih pitanja, osjećajte se slobodno da nas
              kontaktirate.
            </p>
            <div
              class="
            ...
            >
              <div class="d-flex align-items-center p-3">
                <div
                  class="
                    bs-icon-md bs-icon-rounded bs-icon-primary
                    d-flex
                    flex-shrink-0
                    justify-content-center
                    align-items-center
              ...
              <div class="d-flex align-items-center p-3">
                ...
                <div class="px-2">
                  ...
                  <p class="mb-0">Kemala Kapetanovica 17, 71 000 Sarajevo</p>
                </div>
              </div>
            </div>
          </div>
